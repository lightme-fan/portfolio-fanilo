    ...
    K9FK: function(e, t, a) {
      ...
      var r = a("vOnD").c.div.withConfig({
        ...
        [
          ...
          ";height:",
          ";}.grid-item{margin-bottom:20px;.project-image{max-height:272px;height:242px;border:2px solid rgba(0,0,0,0.3);border-radius:7px;}}@media (min-width:700px){margin-bottom:45px;}}@media (max-width:500px){.grid-container{grid-template-columns:repeat(1,1fr);height:100%;}",
          "}"
        ],
        function(e) {
    ...
    Zttt: function(e, t, a) {
      ...
      function h() {
        return n.a.createElement(f, {
          ...
          menuCloseButton: n.a.createElement(i.d, {
            size: 30,
            color: "#616CAA"
          }),
          changeMenuOn: "500px",
...
//# sourceMappingURL=c169b6902947a77fec05096cb4da441bfcc3d6f1-3101a5e3cdebdfdf1959.js.map
